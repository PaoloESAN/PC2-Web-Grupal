      ...
      <div class="row items-center justify-between q-mb-xl hero-section q-pa-xl text-white rounded-2xl shadow-6">
        <div class="col-12 col-md-8">
          <h1 class="text-h3 text-weight-bold q-my-none text-shadow flex items-center gap-sm">
            <q-icon name="filter_alt" class="q-mr-sm" size="50px" />
            Filtros Avanzados
          </h1>
        ...
        <q-card-section class="q-pa-none">
          <q-table :rows="paginatedRows" :columns="columns" v-model:pagination="pagination" row-key="id"
            ...
            <template v-slot:body-cell-age="props">
              <q-td :props="props" class="text-center">
                <q-badge color="grey-2" text-color="slate-800" class="q-py-xs q-px-sm text-weight-medium border-grey-300">
                  {{ props.value }} años
                </q-badge>
              </q-td>
            </template>
            ...
            <template v-slot:loading>
              <q-inner-loading showing color="primary">
                ...
                <div class="text-primary text-subtitle1 text-weight-bold q-mt-md">Cargando...</div>
              </q-inner-loading>
            </template>
          </q-table>
        </q-card-section>
